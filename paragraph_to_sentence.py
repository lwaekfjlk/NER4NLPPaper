...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--infile', default='./data/anlp_test/anlp-sciner-test.txt',
        help='The provided test set file')
    parser.add_argument('-o', '--outfile', default='./data/anlp_test/anlp-sciner-test-sentences.txt',
